...
<div class="container mt-4">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="formDeliveredForm" action="<?php echo e(route('save-form-delivered')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <table class="table table-bordered mt-5">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $peoples; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $people): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-age="<?php echo e($people->age); ?>" data-accessibility="<?php echo e($people->accessibility); ?>">
                                ...
                                <td>
                                    <input type="checkbox" 
                                           name="form_delivered[]" 
                                           value="<?php echo e($people->id); ?>" 
                                           <?php echo e($people->form_delivered ? 'checked disabled' : ''); ?>>
                                </td>
                            </tr>
...
<?php /**PATH C:\xampp\htdocs\laravel_proj_try_four\custom-login-page\resources\views/blo_dashboard.blade.php ENDPATH**/ ?>